  ...
  return (
    <div className="wallet-connect-container">
      <h4 className="wallet-connect-header">
        👻 CONNECT PHANTOM TO HERMESCHAIN
      </h4>
      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to Hermeschain via Phantom: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Phantom wallet to interact with the Hermeschain network
          </p>
          ...
          <div className="wallet-support-info">
            Phantom wallet for Solana-based Hermeschain interaction
          </div>
        </div>
      )}
    </div>
