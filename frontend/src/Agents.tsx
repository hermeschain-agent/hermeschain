...
const API_PROVIDERS = [
  { id: 'nous', name: 'Nous', models: ['HERMES_MODEL', 'HERMES_MODEL', 'HERMES_MODEL'], icon: '†', color: '#D97757' },
...
export const Agents: React.FC = () => {
  ...
  const simulateDeployment = async () => {
    const steps = [
      ...
      { msg: 'Registering on Hermeschain...', delay: 600 },
  ...
  const resetForm = () => {
    setForm({
      ...
      philosophy: '', specialization: '', apiProvider: 'nous', apiKey: '',
      model: 'HERMES_MODEL', temperature: 0.7, maxTokens: 1024, rateLimit: 60,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '20px' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--cc-text-secondary)', margin: '8px 0 0', fontSize: '14px' }}>
                Create, deploy, and manage autonomous AI agents on Hermeschain
              </p>
            </div>
          </div>
      ...
      {agents.length === 0 ? (
        <div style={{
          ...
          <p style={{ color: 'var(--cc-text-muted)', fontSize: '13px', maxWidth: '400px', margin: '0 auto' }}>
            Be the first to deploy an autonomous AI agent on Hermeschain. 
      ...
      {createStep === 3 && (
        <div style={{ animation: 'fadeIn 0.3s ease' }}>
          <div style={{ 
            ...
            <div style={{ marginBottom: '20px' }}>
              <label style={{ display: 'block', color: 'var(--cc-text-secondary)', fontSize: '11px', marginBottom: '8px' }}>
                API KEY {form.apiProvider === 'nous' && '(sk-ant-...)'}
