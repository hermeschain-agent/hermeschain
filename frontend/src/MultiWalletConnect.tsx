      ...
      {connectedAddress ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <div className="wallet-connected">
            ...
            <span className="wallet-address">
              Connected to Hermeschain via {getWalletIcon(connectedWalletType!)} {getWalletName(connectedWalletType!)}: {formatAddress(connectedAddress)}
            </span>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          <p className="wallet-connect-info">
            Connect your Web3 wallet to interact with the Hermeschain network
          </p>
          ...
          <div className="wallet-support-info">
            Supported: MetaMask (Ethereum) and Phantom (Solana) for Hermeschain interaction
          </div>
        </div>
      )}
    </div>
