...
-- Receipts table moved to migrations/0001_receipts.sql so future schema
-- work goes through the migration runner instead of inline edits here.
...
-- Hermeschain Improvement Proposals (CIPs)
...
INSERT INTO chain_state (key, value) VALUES ('network_name', 'Hermeschain Mainnet')
ON CONFLICT (key) DO NOTHING;
`;
