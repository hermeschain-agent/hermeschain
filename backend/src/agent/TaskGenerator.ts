...
const TASK_TEMPLATES: TaskTemplate[] = [
  {
    ...
    prompts: [
      `Build a token balance checking utility for Hermeschain. 
...
Think through the design, then write the TypeScript code.`,
      ...
      `Create a gas estimation utility for Hermeschain transactions.
...
Walk through your reasoning and implement it.`,
      ...
      `Build an address validation utility for Hermeschain.

Requirements:
- Validate Hermeschain address format (base58)
...
Show your work as you build this.`,
      ...
      `Create a transaction hash generator for Hermeschain.
...
Provide security analysis and recommendations.`,
  ...
  },
  {
    ...
    prompts: [
      `Analyze Hermeschain network performance over recent blocks.
...
Generate a performance report with visualizations.`,
      ...
      `Analyze transaction patterns on Hermeschain.
...
Generate a validator health report.`,
      ...
      `Analyze gas usage trends across Hermeschain.
...
Create a gas economics report.`,
      ...
      `Analyze the stake distribution across Hermeschain.
...
Make it ready for council review.`,
      ...
      `Propose an improved fee model for Hermeschain.
...
Draft a complete MIP (Hermeschain Improvement Proposal).`,
...
Make it comprehensive and ready for debate.`,
      ...
      `Propose performance optimizations for Hermeschain.
...
Draft a technical improvement proposal.`,
      ...
      `Propose a new transaction type for Hermeschain.
...
Create a detailed technical proposal.`,
  ...
  },
  {
    ...
    prompts: [
      `Write API documentation for Hermeschain endpoints.
...
Make it developer-friendly with examples.`,
      ...
      `Create a getting started guide for Hermeschain developers.
...
Make it practical with examples.`,
      ...
      `Document security best practices for Hermeschain.
...
Create comprehensive integration tests.`,
      ...
      `Design stress tests for Hermeschain.
...
Document test methodology and results.`,
      ...
      `Write edge case tests for Hermeschain.
