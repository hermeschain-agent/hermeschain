...
export type SourceTaskStatus = 'queued' | 'selected' | 'in_progress' | 'succeeded' | 'failed' | 'blocked' | 'discarded';
export type TaskRunStatus = 'queued' | 'selected' | 'analyzing' | 'executing' | 'verifying' | 'succeeded' | 'failed' | 'blocked' | 'discarded';
export type VerificationStatus = 'pending' | 'running' | 'passed' | 'failed' | 'not_applicable';
