...
const validateBasics = (submission) => {
...
const evaluateProposal = async (submission) => {
    const systemPrompt = `You are a Hermeschain governance moderator. Your job is to evaluate improvement proposals (CIPs) for quality and relevance.
...
- Address a real problem or opportunity for Hermeschain
...
Respond with EXACTLY this JSON format:
{
  ...
  "reason": "Brief explanation of your decision"
    ...
    const userMessage = `Evaluate this Hermeschain Improvement Proposal:
...
// Initialize on load
initializeCIPTables();
//# sourceMappingURL=cip-submit.js.map