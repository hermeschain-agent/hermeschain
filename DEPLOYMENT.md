...
3. OpenRouter API Key for Hermes
...
```bash
# Required variables
railway variables set OPENROUTER_API_KEY="your_claude_api_key"
railway variables set NODE_ENV="production"
railway variables set PORT="4000"
railway variables set CHAIN_ID="1337"
railway variables set CORS_ORIGINS="https://hermeschain.app"
...
### Step 4: Configure Custom Domain (hermeschain.app)
...
5. Enter: `hermeschain.app`
6. Railway will provide DNS records

#### DNS Configuration:
Add these records to your domain registrar:

**For root domain (hermeschain.app):**
```
Type: CNAME
Name: @
...
Visit `https://hermeschain.app` to see your deployed Hermeschain!
...
|----------|----------|-------------|---------|
| `OPENROUTER_API_KEY` | ✅ | Hermes API key from Nous | - |
...
- [ ] Custom domain `hermeschain.app` added to Railway
- [ ] DNS records updated at domain registrar
- [ ] SSL certificate provisioned (automatic)
- [ ] Deployment successful
- [ ] Health check passing at `/health`
- [ ] Application accessible at `https://hermeschain.app`
...
1. Verify DNS propagation: `dig hermeschain.app`
...
- Hermeschain Issues: https://github.com/hermeschain-agent/hermeschain/issues
- Discord: discord.gg/hermeschain
